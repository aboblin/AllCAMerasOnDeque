...
public class DequeTester {
	...
	stringDeque.removeLast(); // there's a problem in this line; it removes the first element instead of the last
	System.out.println( stringDeque ); // b
	System.out.println( "\nRemoving remaining element..." );
	// b should be removed from the deque -- doesn't work
	stringDeque.removeFirst();
	...
	} catch (Exception e) { // your code throws the wrong exception
